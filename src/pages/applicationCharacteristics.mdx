...
> [!Tip] For storage devices, manufacturers use GB (decimal) to make the size look larger, but operating systems use GiB (binary) for calculation, which is why your “500 GB” hard drive shows as ~465 GiB. So calculation of Byte to GB 
